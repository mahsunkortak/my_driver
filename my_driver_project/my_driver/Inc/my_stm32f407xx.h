...
#define TIM8_BASE_ADDR					(APB2_BASE_ADDR + 0x10400UL)
#define USART1_BASE_ADDR                (APB2_BASE_ADDR + 0x11000UL)
#define USART6_BASE_ADDR				(APB2_BASE_ADDR + 0x11400UL)
#define SP1_BASE_ADDR					(APB2_BASE_ADDR + 0x13000UL)
#define SP4_BASE_ADDR					(APB2_BASE_ADDR + 0x13400UL)
#define SYSCFG_BASE_ADDR      			(APB2_BASE_ADDR + 0x13800UL)
#define EXTI_BASE_ADDR					(APB2_BASE_ADDR + 0x13C00UL)
...
#define GPIOB_BASE_ADDR					(AHB1_BASE_ADDR + 0x400UL)
#define GPIOC_BASE_ADDR					(AHB1_BASE_ADDR + 0x800UL)
#define GPIOD_BASE_ADDR					(AHB1_BASE_ADDR + 0xC00UL)
